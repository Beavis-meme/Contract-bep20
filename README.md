...
contract BeavisbuttheadmemeBEP20Token is ERC20Permit, IOHM, OlympusAccessControlled {
    using SafeMath for uint256;

    constructor(address _authority) 
    ERC20("Beavis&butthead", "Beavis", 18) 
    ERC20Permit("Beavis&butthead") 
    OlympusAccessControlled(IOlympusAuthority(_authority)) {       
        
        _mint(_authority, 500000000000000000000000000000000); 
